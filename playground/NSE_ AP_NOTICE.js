...
module.exports = {
    createDocDefinition: async (fileParams) => {
        ...
        // console.log('closerDate', closerDate)
        var dd = {
            header: {
                margin: 15,
                columns: [
            ...
            content: [
                ...
                {
                    text: [
                        { text: `\n\n\n Date:  ${date}`, bold: 'true', alignment: 'right' },
                        {
                            text: `\n               
To,
...
Dear Sir/Madam,\n`, bold: 'true'
                        ...
                        { text: `\nSub: Notice of Termination of Authorised Person Agreement/ arrangement – NSE (Earlier Affiliated with Edelweiss Financial Advisors Ltd)\n`, decoration: 'underline', bold: 'true' },

                        {
                            text: `\nAP Registration No :  ${registration.RegistrationNo.toUpperCase()}
`, alignment: 'left', bold: 'true'
...

                {
                    text: [
                        ...
                        {
                            text: `\nWe refer to the various agreements including but not limited to M.O.U., Remissiary Agreement, CTCL agreements and more particularly to the Authorised Person agreement Agreement duly executed/ entered into and subsisting between ourselves. 
