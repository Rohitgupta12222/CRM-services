...
*Mr./Ms/*M/s `,
                        { text: `${apData.Trade_Name== null ? ' ' :apData.Trade_Name.toUpperCase()}`, bold: 'true', decoration: 'underline', alignment: 'justify' },

                        { text: ` (Applicant Trade Name)`, bold: 'true', },
...
\n5. I/We hereby confirm that the information submitted herein is true to the best of my/our knowledge and if at a later date any contrary material information comes to my/our knowledge subsequent to the submission of this application, I/We undertake to keep the Exchange informed about the same.
\nI/We Mr./ M/s. `,
