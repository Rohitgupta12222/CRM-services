...
module.exports = {
    createDocDefinition: async (fileParams) => {
        ...
        let segmentData = await dataaccess.FindAll(segmentMst, { where: { Id: str1 }, attributes: ['Segment_Alias'] })
        let str2 = segmentData.map(e => e.Segment_Alias.toUpperCase()).join(', ')
...
var dd = {
    ...
    content: [
        ...
        table: {
            widths: [36,430,55],
            body: [
                [{text: 'CHECKLIST FOR SUBMITTING DOCUMENTS FOR CHANGE IN NAME/TRADE NAME & ADDRESS OF AUTHORISED PERSON (AP) [PROPRIETORSHIP/PARTNERSHIP/CORPORATE BODY]',colSpan: 3, alignment: 'center', bold:'true'}, {}, {}],
...
`, {text: 'TM',alignment: 'center'}],
                ...
                [{text: '2',alignment: 'center'},  {text: [`Letter from AP requesting member for change in Name/Trade name /Address of AP. 
(In the prescribed format) `,{text: `Duly certified by both AP as well Branch attestation with EBL rubber stamp`, bold:'true'},],}, {text: 'AP',alignment: 'center'}],
                [{text: '3',alignment: 'center'}, {text: [` Certified copy of new PAN CARD proof.`,{text: ` Duly certified by both AP as well 3rd party attestation CA/Notary `, bold:'true'},],}, {text: 'AP',alignment: 'center'}],
                
                [{text: '4',alignment: 'center'},{text: [` Certified copy of address proof (as mentioned in our checklist of AP registration).`,{text: ` Duly certified by both AP as well 3rd party attestation ie. CA/Notary`, bold:'true'},],}, {text: 'AP',alignment: 'center'}],
        [{text: '5',alignment: 'center'},`Old Address should be same as at the time of registration `,{text: 'AP',alignment: 'center'} ]
            ]
        }
    },
    {text:'\n',pageBreak:'before'} , 
...
`,
        { text: `National Stock Exchange of India Ltd. (NSEIL)`, bold: 'true' },
...
Dear Sir/Madam,
`,
        { text: `Sub: Changes in Authorised Person details `, bold: 'true', alignment: 'center' },
